...
(function($, window) {
    ...
    Lavalamp.prototype = {
        ...
        _move: function(el, animate) {
            var pos = el.position();
            var cssProperties;
            if (el.hasClass('wgl-tabs_header')) {
                // ↓ Tabs widget
...
function wglWoocommerceHelper(){
    let body = jQuery('body'),
        ...
        woo_product_content = jQuery('.woo_product_content.primary');
    ...
    function product_class(){
        if ( m_width >= jQuery(window).width() ) {
            woo_product_content.removeClass( 'primary' );
        } else {
            woo_product_content.addClass( 'primary' );
        }
    }
}
